...
{
    public static Apointment ConvertApointmentCreateVMToApointment(this Apointment appointment,
        ApointmentCreateVM appointmentCreateVM)
    {
        var selectedAppointmentDate = DateTime.Parse(appointmentCreateVM.SelectedDate);
    ...
    public static AppointmentGenarelVM ConvertApointmentToAppointmentGenarelVM(this Apointment appointment)
    {
        ...
        if (appointment.Prescription is not null)
            appointmentGenarelVM.PrescriptionViewModel =
                appointment.Prescription.ConvertPresciptionToPrescriptionViewModel();

        // Return the updated appointment object
        return appointmentGenarelVM;
    }

    public static Apointment ConvertAppointmentGenarelVMToApointment(this Apointment appointment,
        AppointmentGenarelVM AppointmentGenarelVM)
    {
        ...
        if (PrescriptionVM is not null)
            ...
            {
                PrescriptionItems = PrescriptionVM.PrescriptionItems
                    .Select(pi => pi.PrescriptionItemDoctorVMToPrescriptionItem()).ToList(),
    ...
    public static Apointment FromReceptionToAppointment(this Apointment appointment,
        ReceptionAppiontmentViewModel receptionAppiontmentViewModel)
    {
    ...
    public static ReceptionAppiontmentViewModel ConvertToReceptionAppointmentVM(
        this Apointment appointment /*, Receptionist receptionist*/)
    {
