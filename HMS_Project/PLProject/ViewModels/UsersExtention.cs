...
public static class UsersExtention
{
    public static Nurse UpdateInfo(this Nurse nurse, NurseViewModel nurseViewModel)
    {
        ...
        nurse.AppUser.FullName =
            $"{nurseViewModel.FirstName.Trim()} {nurseViewModel.MiddleName.Trim()} {nurseViewModel.LastName.Trim()}";
    ...
    public static Pharmacist UpdateInfo(this Pharmacist pharmacist, PharmacistViewModel pharmacistViewModel)
    {
        ...
        pharmacist.AppUser.FullName =
            $"{pharmacistViewModel.FirstName.Trim()} {pharmacistViewModel.MiddleName.Trim()} {pharmacistViewModel.LastName.Trim()}";
    ...
    public static Receptionist UpdateInfo(this Receptionist receptionist, ReceptionistViewModel receptionistViewModel)
    {
        ...
        receptionist.AppUser.FullName =
            $"{receptionistViewModel.FirstName.Trim()} {receptionistViewModel.MiddleName.Trim()} {receptionistViewModel.LastName.Trim()}";
    ...
    public static Patient UpdateInfo(this Patient patient, PatientViewModel patientViewModel)
    {
        ...
        patient.AppUser.FullName =
            $"{patientViewModel.FirstName.Trim()} {patientViewModel.MiddleName.Trim()} {patientViewModel.LastName.Trim()}";
