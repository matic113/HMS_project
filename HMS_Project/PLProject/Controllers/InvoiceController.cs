...
public class InvoiceController : Controller
{
    ...
    public IActionResult Index(int? page)
    {
        ...
        var spec = new BaseSpecification<Apointment>( /*&&a.ApointmentDate==DateOnly.FromDateTime(DateTime.Now)*/a =>
            a.ApointmentStatus != ApointmentStatusEnum.Completed &&
            a.ApointmentStatus != ApointmentStatusEnum.Cancelled);
    ...
    public IActionResult Edit([FromRoute] int Id, InvoiceViewModel invoiceViewModel)
    {
        ...
        var invoice = unitOfWork.Repository<Invoice>().Get(invoiceViewModel.Id);
